...
const chips = {
  warmPink: createChip("base-warm-pink", "웜 핑크", "Warm Pink", "#FDB5A9", { l: 0.82, c: 0.06, h: 45 }, "red"),
  coolPink: createChip("base-cool-pink", "쿨 핑크", "Cool Pink", "#FFACB9", { l: 0.82, c: 0.08, h: 350 }, "purplePink"),
  warmYellow: createChip("base-warm-yellow", "웜 옐로우", "Warm Yellow", "#FFF382", { l: 0.93, c: 0.08, h: 95 }, "yellow"),
  coolYellow: createChip("base-cool-yellow", "쿨 옐로우", "Cool Yellow", "#FAFF7B", { l: 0.95, c: 0.1, h: 105 }, "yellow"),
  warmGreen: createChip("base-warm-green", "웜 그린", "Warm Green", "#D1FE7E", { l: 0.88, c: 0.14, h: 118 }, "green"),
  coolGreen: createChip("base-cool-green", "쿨 그린", "Cool Green", "#95F8B9", { l: 0.9, c: 0.1, h: 165 }, "green"),
  warmBlue: createChip("base-warm-blue", "웜 블루", "Warm Blue", "#95FFFA", { l: 0.9, c: 0.08, h: 185 }, "blue"),
  coolBlue: createChip("base-cool-blue", "쿨 블루", "Cool Blue", "#AEE1F8", { l: 0.87, c: 0.04, h: 240 }, "blue"),
  ivory: createChip("base-ivory", "아이보리", "Ivory", "#FEF9DD", { l: 0.97, c: 0.02, h: 90 }, "neutral"),
  whiteBasic: createChip("base-white", "화이트", "White", "#F4FCFF", { l: 0.96, c: 0.01, h: 240 }, "neutral"),

  springSeasonRed: createChip("season-spring-red", "봄 레드", "Spring Red", "#FFDACA", { l: 0.9, c: 0.04, h: 30 }, "red"),
  autumnSeasonRed: createChip("season-autumn-red", "가을 레드", "Autumn Red", "#A00605", { l: 0.35, c: 0.14, h: 25 }, "red"),
  springSeasonOrange: createChip("season-spring-orange", "봄 오렌지", "Spring Orange", "#FFDD8C", { l: 0.92, c: 0.06, h: 85 }, "orange"),
  autumnSeasonOrange: createChip("season-autumn-orange", "가을 오렌지", "Autumn Orange", "#BF4E14", { l: 0.5, c: 0.12, h: 50 }, "orange"),
  springSeasonGreen: createChip("season-spring-green", "봄 그린", "Spring Green", "#9CFD5F", { l: 0.86, c: 0.18, h: 130 }, "green"),
  autumnSeasonGreen: createChip("season-autumn-green", "가을 그린", "Autumn Green", "#35721B", { l: 0.38, c: 0.1, h: 135 }, "green"),
  summerSeasonRed: createChip("season-summer-red", "여름 레드", "Summer Red", "#FFC7EA", { l: 0.86, c: 0.07, h: 350 }, "purplePink"),
  winterSeasonRed: createChip("season-winter-red", "겨울 레드", "Winter Red", "#9E0030", { l: 0.35, c: 0.16, h: 355 }, "red"),
  summerSeasonBlue: createChip("season-summer-blue", "여름 블루", "Summer Blue", "#C6E7FF", { l: 0.94, c: 0.02, h: 240 }, "blue"),
  winterSeasonBlue: createChip("season-winter-blue", "겨울 블루", "Winter Blue", "#011893", { l: 0.28, c: 0.14, h: 260 }, "blue"),
  summerSeasonPurple: createChip("season-summer-purple", "여름 퍼플", "Summer Purple", "#E8D6FB", { l: 0.9, c: 0.05, h: 300 }, "purplePink"),
  winterSeasonPurple: createChip("season-winter-purple", "겨울 퍼플", "Winter Purple", "#521B93", { l: 0.3, c: 0.18, h: 295 }, "purplePink"),

  springLightPink: createChip("detail-spring-light-pink", "라이트 핑크", "Light Pink", "#FFDACA", { l: 0.88, c: 0.04, h: 15 }, "purplePink"),
  springLightPeach: createChip("detail-spring-light-peach", "라이트 피치", "Light Peach", "#FEE0AC", { l: 0.9, c: 0.05, h: 65 }, "orange"),
  springLightCreamYellow: createChip("detail-spring-light-cream-yellow", "크림 옐로우", "Cream Yellow", "#FEEFB1", { l: 0.95, c: 0.05, h: 100 }, "yellow"),
  springLightLime: createChip("detail-spring-light-lime", "라이트 라임", "Light Lime", "#D7FAA3", { l: 0.93, c: 0.08, h: 118 }, "green"),
  springLightMint: createChip("detail-spring-light-mint", "라이트 민트", "Light Mint", "#B1FBEA", { l: 0.92, c: 0.05, h: 175 }, "green"),

  springBrightRed: createChip("detail-spring-bright-red", "브라이트 레드", "Bright Red", "#FF5747", { l: 0.6, c: 0.22, h: 25 }, "red"),
  springBrightOrange: createChip("detail-spring-bright-orange", "브라이트 오렌지", "Bright Orange", "#FFB645", { l: 0.72, c: 0.18, h: 65 }, "orange"),
  springBrightYellow: createChip("detail-spring-bright-yellow", "브라이트 옐로우", "Bright Yellow", "#FFE434", { l: 0.87, c: 0.17, h: 90 }, "yellow"),
  brightSharedGreen: createChip("detail-bright-green", "브라이트 그린", "Bright Green", "#00D662", { l: 0.7, c: 0.18, h: 150 }, "green"),
  springBrightBlue: createChip("detail-spring-bright-blue", "브라이트 블루", "Bright Blue", "#19CBFF", { l: 0.62, c: 0.16, h: 245 }, "blue"),

  autumnMutedRose: createChip("detail-autumn-muted-rose", "뮤트 로즈", "Muted Rose", "#E99582", { l: 0.7, c: 0.07, h: 18 }, "red"),
  autumnMutedOrange: createChip("detail-autumn-muted-orange", "뮤트 오렌지", "Muted Orange", "#DEA749", { l: 0.74, c: 0.11, h: 70 }, "orange"),
  autumnMutedGold: createChip("detail-autumn-muted-gold", "뮤트 골드", "Muted Gold", "#D4C753", { l: 0.77, c: 0.1, h: 98 }, "yellow"),
  autumnMutedSage: createChip("detail-autumn-muted-sage", "세이지 그린", "Sage Green", "#8AB77C", { l: 0.73, c: 0.07, h: 135 }, "green"),
  autumnMutedBlue: createChip("detail-autumn-muted-blue", "뮤트 블루", "Muted Blue", "#66AFBA", { l: 0.7, c: 0.04, h: 220 }, "blue"),

  autumnDarkRed: createChip("detail-autumn-dark-red", "다크 레드", "Dark Red", "#962B15", { l: 0.37, c: 0.12, h: 22 }, "red"),
  autumnDarkRust: createChip("detail-autumn-dark-rust", "러스트", "Rust", "#984800", { l: 0.47, c: 0.12, h: 55 }, "orange"),
  autumnDarkGold: createChip("detail-autumn-dark-gold", "다크 골드", "Dark Gold", "#A18200", { l: 0.55, c: 0.1, h: 95 }, "yellow"),
  autumnDarkGreen: createChip("detail-autumn-dark-green", "다크 그린", "Dark Green", "#276106", { l: 0.36, c: 0.09, h: 140 }, "green"),
  autumnDarkTeal: createChip("detail-autumn-dark-teal", "다크 틸", "Dark Teal", "#005D6E", { l: 0.38, c: 0.06, h: 210 }, "blue"),

  summerLightPink: createChip("detail-summer-light-pink", "라이트 핑크", "Light Pink", "#FFCADC", { l: 0.85, c: 0.05, h: 350 }, "purplePink"),
  summerLightMint: createChip("detail-summer-light-mint", "라이트 민트", "Light Mint", "#B6FCD9", { l: 0.91, c: 0.06, h: 155 }, "green"),
  summerLightBlue: createChip("detail-summer-light-blue", "라이트 블루", "Light Blue", "#C6E7FF", { l: 0.88, c: 0.04, h: 245 }, "blue"),
  summerLightLavender: createChip("detail-summer-light-lavender", "라이트 라벤더", "Light Lavender", "#DDD5FC", { l: 0.87, c: 0.04, h: 290 }, "purplePink"),
  summerLightPurple: createChip("detail-summer-light-purple", "라이트 퍼플", "Light Purple", "#F4D4FB", { l: 0.86, c: 0.05, h: 320 }, "purplePink"),

  summerMutedDustyRose: createChip("detail-summer-muted-dusty-rose", "더스티 로즈", "Dusty Rose", "#E7B5CA", { l: 0.68, c: 0.05, h: 5 }, "red"),
  summerMutedGreen: createChip("detail-summer-muted-green", "뮤트 그린", "Muted Green", "#75D1A5", { l: 0.7, c: 0.07, h: 158 }, "green"),
  summerMutedBlue: createChip("detail-summer-muted-blue", "뮤트 블루", "Muted Blue", "#91C0DE", { l: 0.67, c: 0.06, h: 250 }, "blue"),
  summerMutedLavender: createChip("detail-summer-muted-lavender", "뮤트 라벤더", "Muted Lavender", "#B6B7E8", { l: 0.67, c: 0.06, h: 285 }, "purplePink"),
  summerMutedPurple: createChip("detail-summer-muted-purple", "뮤트 퍼플", "Muted Purple", "#CCB1D9", { l: 0.65, c: 0.05, h: 310 }, "purplePink"),

  winterBrightPink: createChip("detail-winter-bright-pink", "핫 핑크", "Hot Pink", "#FF35A1", { l: 0.58, c: 0.24, h: 345 }, "purplePink"),
  winterBrightGreen: createChip("detail-winter-bright-green", "브라이트 그린", "Bright Green", "#00C061", { l: 0.48, c: 0.22, h: 260 }, "green"),
  winterBrightBlue: createChip("detail-winter-bright-blue", "브라이트 블루", "Bright Blue", "#005CFF", { l: 0.48, c: 0.22, h: 260 }, "blue"),
  winterBrightPurple: createChip("detail-winter-bright-purple", "퍼플", "Purple", "#A317FF", { l: 0.45, c: 0.2, h: 295 }, "purplePink"),
  winterBrightMagenta: createChip("detail-winter-bright-magenta", "마젠타", "Magenta", "#CC00F4", { l: 0.55, c: 0.24, h: 320 }, "purplePink"),

  winterDarkWine: createChip("detail-winter-dark-wine", "다크 와인", "Dark Wine", "#89034A", { l: 0.3, c: 0.12, h: 355 }, "red"),
  winterDarkGreen: createChip("detail-winter-dark-green", "다크 그린", "Dark Green", "#003A26", { l: 0.25, c: 0.06, h: 165 }, "green"),
  winterDarkNavy: createChip("detail-winter-dark-navy", "다크 네이비", "Dark Navy", "#011893", { l: 0.2, c: 0.09, h: 260 }, "blue"),
  winterDarkPurple: createChip("detail-winter-dark-purple", "다크 퍼플", "Dark Purple", "#521B93", { l: 0.25, c: 0.14, h: 295 }, "purplePink"),
  winterDarkMagenta: createChip("detail-winter-dark-magenta", "다크 마젠타", "Dark Magenta", "#6F0072", { l: 0.3, c: 0.12, h: 335 }, "purplePink"),
};
