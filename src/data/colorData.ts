...
const chips = {
  ...
  warmYellow: createChip("base-warm-yellow", "웜 옐로우", "Clear Yellow", "#FFF382", { l: 0.951, c: 0.135, h: 103.2 }, "yellow"),
  coolYellow: createChip("base-cool-yellow", "쿨 옐로우", "Dolly", "#FAFF7B", { l: 0.971, c: 0.155, h: 110.9 }, "yellow"),
  warmGreen: createChip("base-warm-green", "웜 그린", "Mindaro", "#D1FE7E", { l: 0.939, c: 0.163, h: 125.4 }, "green"),
  coolGreen: createChip("base-cool-green", "쿨 그린", "Fresh Mint Green", "#95F8B9", { l: 0.902, c: 0.128, h: 155 }, "green"),
  warmBlue: createChip("base-warm-blue", "웜 블루", "Ice Blue", "#95FFFA", { l: 0.935, c: 0.099, h: 191.7 }, "blue"),
  coolBlue: createChip("base-cool-blue", "쿨 블루", "Heaven", "#AEE1F8", { l: 0.882, c: 0.061, h: 227.3 }, "blue"),
  ivory: createChip("base-ivory", "아이보리", "Cornsilk", "#FEF9DD", { l: 0.979, c: 0.037, h: 98.7 }, "neutral"),
  whiteBasic: createChip("base-white", "화이트", "Arctic Ice", "#F4FCFF", { l: 0.986, c: 0.009, h: 222.1 }, "neutral"),

  springSeasonRed: createChip("season-spring-red", "봄 레드", "Unbleached Silk", "#FFDACA", { l: 0.915, c: 0.047, h: 44.7 }, "red"),
  autumnSeasonRed: createChip("season-autumn-red", "가을 레드", "Classic Rose", "#A00605", { l: 0.446, c: 0.18, h: 29 }, "red"),
  springSeasonOrange: createChip("season-spring-orange", "봄 오렌지", "Salomie", "#FFDD8C", { l: 0.909, c: 0.107, h: 87.5 }, "orange"),
  autumnSeasonOrange: createChip("season-autumn-orange", "가을 오렌지", "Orange Roughy", "#BF4E14", { l: 0.565, c: 0.159, h: 42.8 }, "orange"),
  springSeasonGreen: createChip("season-spring-green", "봄 그린", "New Green", "#9CFD5F", { l: 0.903, c: 0.213, h: 135.4 }, "green"),
  autumnSeasonGreen: createChip("season-autumn-green", "가을 그린", "Palm Green", "#35721B", { l: 0.493, c: 0.135, h: 138.1 }, "green"),
  summerSeasonRed: createChip("season-summer-red", "여름 레드", "Paris Pink", "#FFC7EA", { l: 0.889, c: 0.078, h: 340.9 }, "purplePink"),
  winterSeasonRed: createChip("season-winter-red", "겨울 레드", "Arabian Red", "#9E0030", { l: 0.444, c: 0.178, h: 16 }, "red"),
  summerSeasonBlue: createChip("season-summer-blue", "여름 블루", "Cute Sky Blue", "#C6E7FF", { l: 0.912, c: 0.048, h: 239.7 }, "blue"),
  winterSeasonBlue: createChip("season-winter-blue", "겨울 블루", "Indigo Dye", "#011893", { l: 0.321, c: 0.194, h: 264.3 }, "blue"),
  summerSeasonPurple: createChip("season-summer-purple", "여름 퍼플", "Cute Lavender", "#E8D6FB", { l: 0.902, c: 0.053, h: 307.2 }, "purplePink"),
  winterSeasonPurple: createChip("season-winter-purple", "겨울 퍼플", "American Violet", "#521B93", { l: 0.383, c: 0.179, h: 297.9 }, "purplePink"),

  springLightPink: createChip("detail-spring-light-pink", "라이트 핑크", "Unbleached Silk", "#FFDACA", { l: 0.915, c: 0.047, h: 44.7 }, "purplePink"),
  springLightPeach: createChip("detail-spring-light-peach", "라이트 피치", "Navajo White", "#FEE0AC", { l: 0.919, c: 0.075, h: 81.2 }, "orange"),
  springLightCreamYellow: createChip("detail-spring-light-cream-yellow", "크림 옐로우", "Creamy Buttermilk", "#FEEFB1", { l: 0.95, c: 0.08, h: 96.1 }, "yellow"),
  springLightLime: createChip("detail-spring-light-lime", "라이트 라임", "Gossip", "#D7FAA3", { l: 0.94, c: 0.117, h: 126.4 }, "green"),
  springLightMint: createChip("detail-spring-light-mint", "라이트 민트", "Ice Cold Water", "#B1FBEA", { l: 0.935, c: 0.077, h: 178.6 }, "green"),

  springBrightRed: createChip("detail-spring-bright-red", "브라이트 레드", "Neon Coral", "#FF5747", { l: 0.682, c: 0.206, h: 29 }, "red"),
  springBrightOrange: createChip("detail-spring-bright-orange", "브라이트 오렌지", "Tangy", "#FFB645", { l: 0.826, c: 0.15, h: 74.3 }, "orange"),
  springBrightYellow: createChip("detail-spring-bright-yellow", "브라이트 옐로우", "Bright Golden Yellow", "#FFE434", { l: 0.914, c: 0.178, h: 99.8 }, "yellow"),
  brightSharedGreen: createChip("detail-bright-green", "브라이트 그린", "Malachite", "#00D662", { l: 0.765, c: 0.212, h: 149.7 }, "green"),
  springBrightBlue: createChip("detail-spring-bright-blue", "브라이트 블루", "Neon Aqua Blue", "#19CBFF", { l: 0.785, c: 0.146, h: 225.4 }, "blue"),

  autumnMutedRose: createChip("detail-autumn-muted-rose", "뮤트 로즈", "Baby Coral", "#E99582", { l: 0.751, c: 0.106, h: 33.4 }, "red"),
  autumnMutedOrange: createChip("detail-autumn-muted-orange", "뮤트 오렌지", "Pastel Musk", "#DEA749", { l: 0.763, c: 0.127, h: 78 }, "orange"),
  autumnMutedGold: createChip("detail-autumn-muted-gold", "뮤트 골드", "Special Yellow", "#D4C753", { l: 0.818, c: 0.137, h: 102.9 }, "yellow"),
  autumnMutedSage: createChip("detail-autumn-muted-sage", "세이지 그린", "Avery", "#8AB77C", { l: 0.732, c: 0.096, h: 138.4 }, "green"),
  autumnMutedBlue: createChip("detail-autumn-muted-blue", "뮤트 블루", "Pastel Teal", "#66AFBA", { l: 0.71, c: 0.075, h: 208 }, "blue"),

  autumnDarkRed: createChip("detail-autumn-dark-red", "다크 레드", "Crab Apple", "#962B15", { l: 0.452, c: 0.146, h: 33.3 }, "red"),
  autumnDarkRust: createChip("detail-autumn-dark-rust", "러스트", "Alert Tan", "#984800", { l: 0.495, c: 0.127, h: 51.9 }, "orange"),
  autumnDarkGold: createChip("detail-autumn-dark-gold", "다크 골드", "Bronze Coin", "#A18200", { l: 0.618, c: 0.126, h: 91.9 }, "yellow"),
  autumnDarkGreen: createChip("detail-autumn-dark-green", "다크 그린", "Bamboo", "#276106", { l: 0.437, c: 0.131, h: 137.8 }, "green"),
  autumnDarkTeal: createChip("detail-autumn-dark-teal", "다크 틸", "Bold Teal", "#005D6E", { l: 0.441, c: 0.078, h: 215.8 }, "blue"),

  summerLightPink: createChip("detail-summer-light-pink", "라이트 핑크", "Fresh Pink", "#FFCADC", { l: 0.89, c: 0.064, h: 356.2 }, "purplePink"),
  summerLightMint: createChip("detail-summer-light-mint", "라이트 민트", "Peppermint", "#B6FCD9", { l: 0.935, c: 0.084, h: 162.5 }, "green"),
  summerLightBlue: createChip("detail-summer-light-blue", "라이트 블루", "Cute Sky Blue", "#C6E7FF", { l: 0.912, c: 0.048, h: 239.7 }, "blue"),
  summerLightLavender: createChip("detail-summer-light-lavender", "라이트 라벤더", "Lilac", "#DDD5FC", { l: 0.892, c: 0.054, h: 294.7 }, "purplePink"),
  summerLightPurple: createChip("detail-summer-light-purple", "라이트 퍼플", "Cute Violet", "#F4D4FB", { l: 0.908, c: 0.062, h: 320.2 }, "purplePink"),

  summerMutedDustyRose: createChip("detail-summer-muted-dusty-rose", "더스티 로즈", "Peony", "#E7B5CA", { l: 0.824, c: 0.064, h: 351.5 }, "red"),
  summerMutedGreen: createChip("detail-summer-muted-green", "뮤트 그린", "Minty", "#75D1A5", { l: 0.791, c: 0.11, h: 161.7 }, "green"),
  summerMutedBlue: createChip("detail-summer-muted-blue", "뮤트 블루", "Icy Blue", "#91C0DE", { l: 0.785, c: 0.066, h: 236.7 }, "blue"),
  summerMutedLavender: createChip("detail-summer-muted-lavender", "뮤트 라벤더", "Bluish Periwinkle", "#B6B7E8", { l: 0.795, c: 0.069, h: 283.8 }, "purplePink"),
  summerMutedPurple: createChip("detail-summer-muted-purple", "뮤트 퍼플", "English Lilac", "#CCB1D9", { l: 0.796, c: 0.063, h: 314.8 }, "purplePink"),

  winterBrightPink: createChip("detail-winter-bright-pink", "핫 핑크", "Energizing Hot Pink", "#FF35A1", { l: 0.674, c: 0.248, h: 353.9 }, "purplePink"),
  winterBrightGreen: createChip("detail-winter-bright-green", "브라이트 그린", "Dark Spring Green", "#00C061", { l: 0.707, c: 0.187, h: 151.7 }, "green"),
  winterBrightBlue: createChip("detail-winter-bright-blue", "브라이트 블루", "Moroccan Blue", "#005CFF", { l: 0.545, c: 0.252, h: 262 }, "blue"),
  winterBrightPurple: createChip("detail-winter-bright-purple", "퍼플", "Sporty Purple", "#A317FF", { l: 0.578, c: 0.291, h: 304.6 }, "purplePink"),
  winterBrightMagenta: createChip("detail-winter-bright-magenta", "마젠타", "Electric Purple", "#CC00F4", { l: 0.619, c: 0.299, h: 318.7 }, "purplePink"),

  winterDarkWine: createChip("detail-winter-dark-wine", "다크 와인", "Rose Bud Cherry", "#89034A", { l: 0.411, c: 0.165, h: 358.1 }, "red"),
  winterDarkGreen: createChip("detail-winter-dark-green", "다크 그린", "Strong Dark Green", "#003A26", { l: 0.308, c: 0.067, h: 163.1 }, "green"),
  winterDarkNavy: createChip("detail-winter-dark-navy", "다크 네이비", "Indigo Dye", "#011893", { l: 0.321, c: 0.194, h: 264.3 }, "blue"),
  winterDarkPurple: createChip("detail-winter-dark-purple", "다크 퍼플", "American Violet", "#521B93", { l: 0.383, c: 0.179, h: 297.9 }, "purplePink"),
